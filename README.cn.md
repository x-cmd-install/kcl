...
[![x-cmd/install — kcl Code Quality Monitoring Repo Card](https://repo.x-cmd.io/kcl.svg?lang=zh)](https://x-cmd.com/install/kcl)
...
合计: **159,530** 行代码（覆盖前 5 种语言、共 **3293** 个文件）。
...
- **上游仓库**: <https://github.com/kcl-lang/kcl>
...
- **Star**: 2,416 · **Fork**: 170 · **开放 issue**: 735 · **贡献者**: 57

## 累计统计

- **发布数**: 78 · **已合并 PR**: 1244 · **开放 PR**: 0 · **已关闭 issue**: 717 · **开放 issue**: 18 · **提交数**: 1328

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-21 | 0 | 46 | 0 | 2 | 0 | 37 |
| last60d | 2026-07-22 | 0 | 60 | 0 | 5 | 1 | 61 |
| 90d | 2026-06-22 | 0 | 63 | 0 | 8 | 1 | 68 |
| last180d | 2026-03-24 | 0 | 77 | 0 | 12 | 1 | 82 |
| 360d | 2025-09-25 | 0 | 124 | 0 | 38 | 3 | 131 |
| last720d | 2024-09-30 | 11 | 231 | 0 | 192 | 9 | 242 |
...
kcl 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `kcl` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/kcl.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260920.yml` · 2026-09-20T05:02:44Z._
