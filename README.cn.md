...
[![x-cmd/install — kcl Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/kcl.svg?lang=zh)](https://x-cmd.com/install/kcl)
...
合计: **160,957** 行代码（覆盖前 5 种语言、共 **3312** 个文件）。
...
- **Star**: 2,417 · **Fork**: 170 · **开放 issue**: 733 · **贡献者**: 57

## 累计统计

- **发布数**: 78 · **已合并 PR**: 1247 · **开放 PR**: 0 · **已关闭 issue**: 720 · **开放 issue**: 13 · **提交数**: 1331
...
_数据快照: `data/card/260923.yml` · 2026-09-23T04:56:06Z._
